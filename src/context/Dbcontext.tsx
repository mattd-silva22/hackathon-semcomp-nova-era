...
const initialOng = [
  {
    ...
    valorAtual: 15000,
    image:
      "https://s3.amazonaws.com/hub-central/uploads/1497361271_meuriocor.png",
  },
  {
    name: "Baia Azul",
    ...
    valorAtual: 13697,
    image:
      "https://www.mbi.com.br/mbi/files/media/image/simbolopedia/municipio-itapagipe-brasao-simb-brsemg0502133402.jpg",
  },
];
...
const initialUsers = [
  ...
  },
  {
    ...
    xp: 125,
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/004/800/431/small/young-black-woman-smiling-and-looking-at-camera-in-kitchen-free-photo.jpg",
  },
  {
    id: 3,
    name: "Pedro Santos",
...
const initialDenuncias = [
  {
    ...
    location: [-12.983578, -38.50502],
    eventDate: "22/08/2022",
    image:
      "https://falario.com.br/wp-content/uploads/2019/03/2-Valoes-abandonados-em-SG-Rio-California-com-vari_00057833_0.jpg",
    cratedAt: "22/08/2022",
  ...
  },
  {
    ...
    eventDate: "22/08/2022",
    image:
      "http://www.ipatrimonio.org/wp-content/uploads/2018/01/Salvador-Fonte-da-%C3%81gua-Brusca-Imagem-Sipac.jpg",
    cratedAt: "24/08/2022",
...
export function DbContextProvider(props: DbContextProviderProps) {
  ...
  const [denunciaList, setDenunciaList] =
    useState<DenunciaTypes[]>(initialDenuncias);
